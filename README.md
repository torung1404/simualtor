...
- [x] Phase 4: Persistence & Safety (DataStore integration, session locking, schema migration v4, notification service)
- [x] Phase 5: Progression Systems (daily quests, login streaks, welcome-back bonuses, arc progression, boss mechanics, crit system)
